...
import type { MexcPosition } from '@web/shared/api/types';
 ...
 * MEXC as position-level TP/SL orders, so the EXCHANGE closes the position when
      ...
      >
        ...
        <div className="bg-setup-body">
          ...
          <p className="bg-setup-note">
            Lệnh TP/SL được đẩy thẳng lên <strong>MEXC</strong> (kích hoạt theo Fair Price, đóng
