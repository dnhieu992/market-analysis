...
import { CreateCompoundTransactionForm } from '@web/features/create-compound-transaction/create-compound-transaction-form';
import type { CompoundHolding } from '@web/shared/api/types';

type CompoundHoldingsListProps = Readonly<{
  portfolioId: string;
...
function StatsPanel({ holdings, prices, pricesLoaded }: {
  holdings: CompoundHolding[];
...
export function CompoundHoldingsList({ portfolioId, holdings }: CompoundHoldingsListProps) {
  ...
  return (
    <>
      <StatsPanel holdings={holdings} prices={prices} pricesLoaded={pricesLoaded} />
                  ...
                  return (
                    <tr key={h.coinId}>
                      <td data-label="Coin" data-full="">
                        <Link href={`/compound-interest/${portfolioId}/${h.coinId}`} className="tt-symbol-btn">
          ...
          <div className="dialog-backdrop" onClick={() => setAddOpen(false)}>
            <div className="dialog" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="dialog-body">
                <CreateCompoundTransactionForm portfolioId={portfolioId} onSubmitted={() => setAddOpen(false)} />
              </div>
            </div>
          </div>
        )}
