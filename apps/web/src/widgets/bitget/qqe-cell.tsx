...
import type { BitgetQqeTfSignal } from '@web/shared/api/types';
...
export type QqeMap = Record<string, Record<string, BitgetQqeTfSignal | null>>;
...
export const isLiveSignal = (sig: BitgetQqeTfSignal | null | undefined): sig is BitgetQqeTfSignal =>
 ...
 * Long, red for Short. Shared by the Bitget Setup tab and /tracking-coins;
...
export function QqeCell({
  ...
  signals: Record<string, BitgetQqeTfSignal | null> | undefined;
