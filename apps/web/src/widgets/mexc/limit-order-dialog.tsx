 ...
 * order rests on MEXC until the price is reached, then fills into a position.
 */
export function LimitOrderDialog({
  ...
  // order (LONG above price, SHORT below). Allowed by MEXC — just flag it.
  const fillsNow =
      ...
      >
        ...
        <div className="bg-setup-body">
          ...
          <p className="bg-setup-note">
            ...
            <strong>MEXC</strong> ở dạng lệnh chờ — sàn tự mở vị thế khi giá chạm mức, không phụ thuộc
            dashboard này.
          </p>
