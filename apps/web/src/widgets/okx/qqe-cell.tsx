...
import type { OkxQqeTfSignal } from '@web/shared/api/types';
...
export type QqeMap = Record<string, Record<string, OkxQqeTfSignal | null>>;
...
export const isLiveSignal = (sig: OkxQqeTfSignal | null | undefined): sig is OkxQqeTfSignal =>
 ...
 * Long, red for Short. Used by the OKX Setup tab (the Bitget page has its
...
export function QqeCell({
  ...
  signals: Record<string, OkxQqeTfSignal | null> | undefined;
