...
import type { BitgetPosition } from '@web/shared/api/types';
 ...
 * Bitget as position-level plan orders, so the EXCHANGE closes the position when
      ...
      >
        ...
        <div className="bg-setup-body">
          ...
          <p className="bg-setup-note">
            Lệnh TP/SL được đẩy thẳng lên <strong>Bitget</strong> (kích hoạt theo Mark Price, đóng
