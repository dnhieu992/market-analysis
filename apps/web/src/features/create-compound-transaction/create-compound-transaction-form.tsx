...
import { parseCreateCompoundTransactionFormData, submitCreateCompoundTransaction } from './create-compound-transaction.model';

type CreateCompoundTransactionFormProps = Readonly<{
  portfolioId: string;
...
export function CreateCompoundTransactionForm({ portfolioId, defaultCoinId, defaultPrice, onSubmitted }: CreateCompoundTransactionFormProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const parsed = parseCreateCompoundTransactionFormData(formData);
      await submitCreateCompoundTransaction(portfolioId, parsed);
      form.reset();
      setType('buy');
      startTransition(() => {
        onSubmitted?.();
