...
@Module({
  ...
  // the Bitget and MEXC buckets. Both clients take their credentials from env
  // and hold no state, so plain class providers are enough.
  providers: [AssetService, BinanceMarketDataService, BitgetTradeClient, MexcTradeClient],
})
