 ...
 * comparing the current close with the close that many days back. The 24h column
 * is not here: the page reads the exchange's rolling 24h ticker with the price.
 */
