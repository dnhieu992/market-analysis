...
@Module({
  imports: [AnalysisModule, DailySignalModule, TelegramModule, VisualAnalysisModule, SwingSignalModule, SmallCapScanModule, MemeScanModule, SpotFlipDailyModule, TrackingCoinScanModule, EmaStochScanModule, SetupTrackingModule, BitgetHistoryModule],
