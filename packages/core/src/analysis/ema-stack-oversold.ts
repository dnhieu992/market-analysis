 ...
 *      while %K < osLevel.
 *
 * Used by the `ema-stack-oversold-stochrsi` /back-test strategy. (The /ema-bounce scanner
 * page that shared these maths was removed on 2026-07-26, along with its near/reach
 * detector and 0-100 setup scorer.)
 */
