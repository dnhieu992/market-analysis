...
- `apps/web/src/widgets/bitget-history/bitget-history-feed.tsx` — widget: tile thống kê + bảng + auto-refresh 15s (prop `embedded`); nút Reference + `TradeChartGalleryDialog` (gallery scope theo `tradeKey`).
